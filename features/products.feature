Feature: The product store service back-end
    ...
    Scenario: Update a Product
        ...
        And I set the "Description" to "An updated red fedora"
        ...
        And I should see "An updated red fedora" in the "Description" field
    ...
    Scenario: Search for Products by Availability
        ...
        And I press the "Search" button
        Then I should see "Shoes" in the list
        And I should not see "Hat" in the list
        And I should not see "Big Mac" in the list
        And I should not see "Sheets" in the list
